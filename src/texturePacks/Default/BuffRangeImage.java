...
public class BuffRangeImage extends BuffRangeGraphic {
	static private float reduction = 0.5f;
	static private float size = 5;

	BuffRangeImage(ContentPane parent, Game game, Point position) {
	...
	public Image getImage(Dimension dimension) {
		...
		Color[] colors = {new Color(200, 0, 0, 0), Color.RED};
