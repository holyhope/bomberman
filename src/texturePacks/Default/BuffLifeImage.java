...
public class BuffLifeImage extends BuffLifeGraphic {
	static private float reduction = 0.5f;
	static private float size = 5;

	BuffLifeImage(ContentPane parent, Game game, Point position) {
	...
	public Image getImage(Dimension dimension) {
		...
		Color[] colors = {new Color(0, 200, 0, 0), Color.GREEN};
